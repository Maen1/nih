...
model.save('../nih_sample/mobilenet_nih_model_all_50_55.h5')
...
plt.xlabel('epoch')
plt.legend(['train', 'test'], loc='upper left')
plt.savefig('./images/mobilenet_accuracy_all_50_55.png')
...
plt.xlabel('epoch')
plt.legend(['train', 'test'], loc='upper left')
plt.savefig('./images/mobilenet_loss_all_50_55.png')
...
fig.savefig('./images/mobilenet_trained_net_all_50_55.png')
...
for (idx, c_ax) in zip(sickest_idx, m_axs.flatten()):
    ...
    c_ax.axis('off')
fig.savefig('./images/mobilenet_trained_img_predictions_all_50_55.png')
...
y_pred_y_true.to_csv("./csv/mobilenet_nih_predictions_all_50_55.csv", header=True, index=True)
