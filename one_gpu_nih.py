...
model.save('../nih_sample/nih_model_30_01.h5')
...
plt.xlabel('epoch')
plt.legend(['train', 'test'], loc='upper left')
plt.savefig('./images/accuracy_30_01.png')
...
plt.xlabel('epoch')
plt.legend(['train', 'test'], loc='upper left')
plt.savefig('./images/loss_30_01.png')
...
fig.savefig('./images/trained_net_30_01.png')
...
for (idx, c_ax) in zip(sickest_idx, m_axs.flatten()):
    ...
    c_ax.axis('off')
fig.savefig('./images/trained_img_predictions_30_01.png')
...
y_pred_y_true.to_csv("./csv/nih_predictions_30_01.csv", header=True, index=True)
