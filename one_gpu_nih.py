...
#train data set
df_sample_train = df_sample.sample(frac = 0.50, random_state = 55)
...
plt.xlabel('epoch')
plt.legend(['train', 'test'], loc='upper left')
plt.savefig('./images/accuracy_50_50.png')
...
plt.xlabel('epoch')
plt.legend(['train', 'test'], loc='upper left')
plt.savefig('./images/loss_50_50.png')
...
fig.savefig('./images/trained_net_50_50.png')
...
for (idx, c_ax) in zip(sickest_idx, m_axs.flatten()):
    ...
    c_ax.axis('off')
fig.savefig('./images/trained_img_predictions_50_50.png')
