...
df_sample = df_half.sample(frac = 0.5, random_state = 1)
deasises = list(df_sample["Finding Labels"].unique())

#train data set
df_sample_train = df_sample.sample(frac = 0.00, random_state = 1)
...
model.save('../nih_sample/mobilenet_nih_model_all_30_00.h5')
...
plt.xlabel('epoch')
plt.legend(['train', 'test'], loc='upper left')
plt.savefig('./images/mobilenet_accuracy_all_30_00.png')
...
plt.xlabel('epoch')
plt.legend(['train', 'test'], loc='upper left')
plt.savefig('./images/mobilenet_loss_all_30_00.png')
...
fig.savefig('./images/mobilenet_trained_net_all_30_00.png')
...
for (idx, c_ax) in zip(sickest_idx, m_axs.flatten()):
    ...
    c_ax.axis('off')
fig.savefig('./images/mobilenet_trained_img_predictions_all_30_00.png')
...
y_pred_y_true.to_csv("./csv/mobilenet_nih_predictions_all_30_00.csv", header=True, index=True)
