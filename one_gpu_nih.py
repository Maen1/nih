...
model.save('../nih_sample/xception_nih_model_30_01.h5')
...
plt.xlabel('epoch')
plt.legend(['train', 'test'], loc='upper left')
plt.savefig('./xception_images/xception_accuracy_30_01.png')
...
plt.xlabel('epoch')
plt.legend(['train', 'test'], loc='upper left')
plt.savefig('./xception_images/xception_loss_30_01.png')
...
fig.savefig('./xception_images/xception_trained_net_30_01.png')
...
for (idx, c_ax) in zip(sickest_idx, m_axs.flatten()):
    ...
    c_ax.axis('off')
fig.savefig('./xception_images/xception_trained_img_predictions_30_01.png')
...
y_pred_y_true.to_csv("./xception_csv/xception_nih_predictions_30_01.csv", header=True, index=True)
