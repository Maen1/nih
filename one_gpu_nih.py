...
#train data set
df_sample_train = df_sample.sample(frac = 0.05)
...
model.save('../nih_sample/nih_model_50_05.h5')
...
plt.xlabel('epoch')
plt.legend(['train', 'test'], loc='upper left')
plt.savefig('accuracy_50_05.png')
...
fig.savefig('trained_net_50_05.png')
...
for (idx, c_ax) in zip(sickest_idx, m_axs.flatten()):
    ...
    c_ax.axis('off')
fig.savefig('trained_img_predictions_50_05.png')
