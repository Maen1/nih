...
model.save('../nih_sample/xception_nih_model_all_50_35.h5')
...
plt.xlabel('epoch')
plt.legend(['train', 'test'], loc='upper left')
plt.savefig('./xception_images/xception_accuracy_all_50_35.png')
...
plt.xlabel('epoch')
plt.legend(['train', 'test'], loc='upper left')
plt.savefig('./xception_images/xception_loss_all_50_35.png')
...
fig.savefig('./xception_images/xception_trained_net_all_50_35.png')
...
for (idx, c_ax) in zip(sickest_idx, m_axs.flatten()):
    ...
    c_ax.axis('off')
fig.savefig('./xception_images/xception_trained_img_predictions_all_50_35.png')
...
y_pred_y_true.to_csv("./xception_csv/xception_nih_predictions_all_50_35.csv", header=True, index=True)
